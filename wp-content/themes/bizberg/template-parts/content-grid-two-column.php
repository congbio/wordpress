            ...
            <header class="entry-header <?php echo ( empty( $category ) ? 'no_category_post' : '' ); ?>">
                <div class="entry-meta">
                    <span class="posted-on">
                        ...
                        <a
                            href="<?php echo esc_url( home_url() ); ?>/<?php echo esc_attr( date( 'Y/m' , strtotime( get_the_date() ) ) ); ?>">
                ...
                <div class="button-wrap">
                    <a href="<?php the_permalink(); ?>" class="btn-readmore">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="12" height="24" viewBox="0 0 12 24">
                            <path d="M0,12,12,0,5.564,12,12,24Z" transform="translate(12 24) rotate(180)" fill="#121212"></path>
                        </svg>
                    </a>
                </div>
            </div>
