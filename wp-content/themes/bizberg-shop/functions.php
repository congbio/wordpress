...
$html .= "<div class='csw-catory-product  '>";
    ...
    $html .= "<div class='csw-list-product'>";
        ...
        $html .= "<div class='csw-product-item'>";
            ...
            $html .= "<a class='csw-media' href='" . get_the_permalink() . "'>" . get_the_post_thumbnail(get_the_ID(), 'thumnail',
                array('class' => 'thumnail')) . "</a>";
            ...
            $html .= "<a class='csw-add-cart' href='" . home_url() . "?add-to-cart=" . get_the_ID() . "'>" . esc_html__('Thêm vào
                giỏ hàng', 'ntl-csw') . "</a>";
            $html .= "</div>";
        }
        }
...
<?php
 ...
 function bizberg_shop_get_top_categories(){ if( !class_exists( 'WooCommerce' ) ){ return; }
    $bs_top_categories_status=bizberg_get_theme_mod( 'bs_top_categories_status' ); if( empty( $bs_top_categories_status ) ){
    return; } ?>
