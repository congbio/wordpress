        ...
        'fields' => apply_filters(
          ...
          array(
            'author'            =>  '<div class="form-row">' .
              ...
              '<input type="text" id="inputFullName" class="form-control" name="author" placeholder="Ahmet Ylmaz" value="' . esc_attr($commenter['comment_author']) . '" maxlength="245" ' . $aria_req . '>' .
              '</div>',
